...
import com.example.esgimusic.SongsListActivity
import com.example.esgimusic.databinding.CategoryItemRecyclerRowBinding
...
class CategoryAdapter (private val categoryList: List<CategoryModel>) :
    ...
    class MyViewHolder( private val binding: CategoryItemRecyclerRowBinding) :
        RecyclerView.ViewHolder(binding.root) {
            // Lié le modèle de données à la vue
